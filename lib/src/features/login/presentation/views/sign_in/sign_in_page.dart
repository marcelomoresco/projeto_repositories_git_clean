...
import 'package:projeto_repositories_git_clean/src/features/login/presentation/views/sign_up/sign_up_page.dart';
import 'package:projeto_repositories_git_clean/src/features/search/presentator/views/home/home_page.dart';
...
class _SignInPageState extends State<SignInPage> {
  ...
  void submitSignIn() {
    if (_emailController.text.isNotEmpty &&
      ...
      context.read<UserLoginCubit>().submitSignIn(
